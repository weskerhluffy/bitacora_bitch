...
<span class="psdg-bold">NUEVA EMPRESA</span>
<P />
...
<BR />
	...
	<s:form id="frmEmpresa"
		action="%{#request.contextPath}/catalogo-empresa" method="post"
		theme="simple" acceptcharset="UTF-8">
		<div id="formulafont">
		<label><s:text name="cdEmpresaCampo" /> </label>
		<s:textfield name="cdEmpresa" cssClass="campo" />
		...
		<sj:radio id="rdoStDifHorariaPos" list="#{true:'Positiva',false:'Negativa'}"
			name="stDifHorariaPos" value="1" /></div>
