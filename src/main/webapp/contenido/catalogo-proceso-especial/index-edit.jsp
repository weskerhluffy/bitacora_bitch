...
<span class="psdg-bold">EDITAR PROCESO CRÍTICO</span>
<P />
<div id="psdg-light">Catalogo de procesos Críticos -Bitácora Batch</div>
<BR />
<BR />
<BR />
	...
	<s:form id="frmProcesoEspecial"
		action="%{#request.contextPath}/catalogo-proceso-especial/%{id}"
		method="post" theme="simple" acceptcharset="UTF-8">
		<s:hidden name="_method" value="put" />
		<div id="formulafont">
		<div class="spacer">
		<label><s:text name="nbProcesoCampo" />
		</label>
		<s:textfield cssClass="campo" name="nbProceso" /></div>
		<div class="spacer">
		<label><s:text name="nbGrupoCampo" />
		</label>
		...
		<s:select name="cdTipProEsp" list="tiposProcesoEspecialDisponibles"
			...
			cssClass="campo" /></div>
			<div class="spacer2">
		<sj:radio name="model.cdOrigen" list="origenesDisponibles"
