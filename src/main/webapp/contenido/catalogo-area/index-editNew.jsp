...
<span class="psdg-bold">AGREGAR ÁREA</span>
<P />
...
<BR />
	...
	<s:form id="frmArea" action="%{#request.contextPath}/catalogo-area"
		...
		<sj:a id="button2" button="true" 
			href="javascript:void(0);" onclick="location.href='%{urlCancelar}'">Cancelar</sj:a>
			</div>
	</s:form>
	</div>
	</div>
