...
<span class="psdg-bold">ELIMINAR ÁREA</span>
<P />
...
<BR />
	...
	<s:form id="frmArea" action="%{#request.contextPath}/catalogo-area/%{id}"
		method="post" theme="simple" acceptcharset="UTF-8">
		<s:hidden name="_method" value="delete" />
		<div id="formulafont">
		<div class="spacer0">
		<label><s:text name="nombreCampo" /> </label>
		<s:textfield name="nbArea" disabled="true" cssClass="campo" /></div>
